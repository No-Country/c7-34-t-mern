...
function Balance({ setPostBalance, user, movements }) {
  ...
  return (
    <section className="flex flex-col gap-4 md:gap-10 justify-center items-center my-2 sm:my-10">
      <aside>
        <div className="bg-white shadow-md py-2 md:py-6 px-8 rounded-xl grid w-72 sm:w-[25rem] gap-6">
      ...
      <aside className="bg-indigo-100 rounded-md shadow-md mb-4">
