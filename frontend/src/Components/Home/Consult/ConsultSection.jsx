...
const Consult = () => {
  return (
    <section className="flex flex-col items-center">
      ...
      <ul className="flex flex-col md:flex-row items-center md:justify-between w-full px-10 lg:w-4/6">
        <li className="flex flex-col items-center md:items-start md:flex-row w-72">
