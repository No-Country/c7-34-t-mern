    ...
    <footer className='px-20 pt-14 pb-8'>
      <div className="flex flex-col md:flex-row justify-center items-center mb-8">
        <div className='flex md:justify-evenly md:w-3/6 gap-10 mb-4 md:mb-0'>
          <span className='mr-16 md:mr-0 flex justify-center items-center'><img src={logo_brand} width={84} height={84} alt="Coin book logo" /></span>
      ...
      <div className="flex justify-around">
        <p className='max-w-4xl mr-12'>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Habitant sagittis semper ipsum in cras ornare. Ut eleifend mollis sed scelerisque velit. Id sed eu eget tortor lacus, blandit integer. Hac viverra ut enim sed bibendum tellus. Lorem
        </p>
        <button className="rounded-lg bg-green-600/80 hover:bg-green-600/100 text-white h-12 px-5" type="button">Ayuda</button>
      </div>
    </footer>
  );
}
