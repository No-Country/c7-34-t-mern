...
function Sidebar() {
  ...
  return (
    <section className="w-20 hover:w-72 bg-white min-h-screen overflow-hidden hover:overflow-visible top-0 left-0 hover:z-10 hover:fixed transition-[width] duration-75 ease-[cubic-bezier(0.175, 0.885, 0.32, 1.275)]">
